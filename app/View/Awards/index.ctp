<div class="awards index">
	...
	<tr>
		...
		<td><?php echo h($award['Award']['image']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $award['Award']['id']), array(), __('Are you sure you want to delete # %s?', $award['Award']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
