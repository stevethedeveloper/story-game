...
<?php echo $this->Form->create('User'); ?>
    <fieldset>
        ...
        echo $this->Form->input('username', array( 'readonly' => 'readonly', 'label' => 'Screen names cannot be changed!'));
        ...
        echo $this->Form->input('receive_emails', array('label' => 'Receive email notifications'));
        echo $this->Form->submit('Save changes', array('class' => 'form-submit',  'title' => 'Click here to add the user') );
?>
    </fieldset>
